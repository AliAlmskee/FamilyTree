...
<div class="container mx-auto px-4 py-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('news.show', $item) }}" class="text-blue-600 hover:text-blue-800 font-semibold">Read More &rarr;</a>
                        </div>
                    </div>
                </div>
            @endforeach
    ...
    @else
        <div class="text-center py-16 bg-white rounded-lg shadow-md">
            ...
            <h2 class="text-2xl font-semibold text-gray-700 mb-2">No News Yet</h2>
